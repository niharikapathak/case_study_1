...
return(
    ...
    <div className="h-[86vh] mt-[2vh] w-[98vw] flex  ">
        <div className="w-[14vw] h-full border-r-2 flex flex-col items-center justify-between">
        <div className="w-full flex flex-col items-center">
           ...
           {user ? (
             <div
               className={`Niharika bg-[url(${user.photoURL})] flex items-center h-[96%]`}
             >
               <p className="tracking-[2px] flex items-end  h-[100%] ">
                 
                 <p className="font-[500] text-[12px]"> {user.displayName}</p>
               </p>
               <img
                 src={user.photoURL}
                 alt=""
